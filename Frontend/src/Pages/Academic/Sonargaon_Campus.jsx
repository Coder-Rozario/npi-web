      ...
      try {
        ...
        setData({
          ...
          image: fetchedData.image
            ...
            : "/storage/photos/shares/Neded%20Picture/1545365825sonargaon.jpg",
        });
      } catch (error) {
        ...
        <div className="campus-container">
          <div className="premium-card">
            ...
            <div className="image-container">
              <img src={data.image} alt="BNIST Sonargaon Campus - National Polytechnic Institute NPI Sonargaon - Best Polytechnic in Bangladesh" />
            </div>
...
export default Sonargaon_Campus;
