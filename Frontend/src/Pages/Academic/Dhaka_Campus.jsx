    ...
    <>
      <style>{`
        ...
        @media (max-width: 600px) {
          .campus-page-wrapper { padding: 20px 10px; }
          .content-body { padding: 25px 20px; }
          .dynamic-html-content { font-size: 1.15rem; line-height: 1.7; }
          .dynamic-html-content h1 { font-size: 1.85rem; }
          .dynamic-html-content h2 { font-size: 1.6rem; }
          .dynamic-html-content h3 { font-size: 1.4rem; }
          .dynamic-html-content table {
             display: block;
             overflow-x: auto;
             border-radius: 16px;
          }
          .dynamic-html-content th, .dynamic-html-content td {
        ...
        <div className="campus-container">
          <div className="premium-card">
            ...
            <div className="image-container">
              <img src={data.image} alt="Dhaka Campus - National Polytechnic Institute NPI Dhaka - Best Polytechnic in Bangladesh" />
            </div>
