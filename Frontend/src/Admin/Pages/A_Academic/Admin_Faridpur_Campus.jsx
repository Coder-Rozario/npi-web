...
const Admin_Faridpur_Campus = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (data.image) {
          ...
          setImagePreview(`${API_BASE_URL}/storage/photos/shares/Neded%20Picture/1545365652Faridpur1.jpg`);
        }
      } catch (error) {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const response = await authFetch(`${API_BASE_URL}/saveFaridpur`, {
        method: "POST",
        body: formData,
      });
      const data = await response.json();
          ...
          <div className="w-full">
            ...
            <div className="p-8 md:p-14">
              <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                <div>
                   <h2 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Faridpur Campus</h2>
...
export default Admin_Faridpur_Campus;
