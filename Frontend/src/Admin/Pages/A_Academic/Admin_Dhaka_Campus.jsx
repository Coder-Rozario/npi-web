...
const Admin_Dhaka_Campus = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (data.image) {
          ...
          setImagePreview("/storage/photos/shares/15451150562222_copy.jpg");
        }
      } catch (error) {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const response = await authFetch(`${API_BASE_URL}/save`, {
        method: "POST",
        body: formData,
      });
          ...
          <div className="bg-white rounded-[3rem] shadow-[0_30px_70px_-20px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-100">
            <div className="p-8 md:p-14">
              <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                <div>
                   <h2 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Dhaka Campus</h2>
              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="w-full">
                  <div 
                    ...
                    onClick={() => document.getElementById('campusImage').click()}
                  >
                    ...
                    <input id="campusImage" type="file" accept="image/*" className="hidden" onChange={handleImageUpload} />
                  </div>
                </div>
...
export default Admin_Dhaka_Campus;
